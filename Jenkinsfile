...
node {
    ...
    stage('Build image') {
       app = docker.build("654654166929.dkr.ecr.ap-northeast-2.amazonaws.com/study-dockerimage-repo")
    }
    ...
    stage('Push image') {
        docker.withRegistry('https://654654166929.dkr.ecr.ap-northeast-2.amazonaws.com/study-dockerimage-repo', 'ecr:ap-northeast-2:ecr-credential') {
